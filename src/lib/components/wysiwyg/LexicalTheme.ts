export const theme = {
	root: 'outline-none prose',
	placeholder: 'editor-placeholder',
	paragraph: '',
	quote: 'editor-quote',
	heading: {
		h1: 'text-3xl font-extrabold text-base-content',
		h2: 'text-2xl font-bold text-base-content',
		h3: 'text-xl font-bold text-base-content',
		h4: 'text-lg font-bold text-base-content',
		h5: 'font-bold text-base-content'
	},
	list: {
		nested: {
			listitem: 'pl-5 mt-2 space-y-1 list-decimal list-inside text-base-content'
		},
	...
	image: 'editor-image',
	link: 'font-medium text-blue-600 link link-hover link-primary',
	text: {
		bold: 'font-bold',
		italic: 'italic',
