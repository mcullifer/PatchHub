...
{
	[Parameter] public SteamAppNews? NewsContent { get; set; }

	[Parameter] public SteamApp? SteamApplication { get; set; }

	[Parameter] public bool IsMobile { get; set; }

	[Parameter] public EventCallback<SteamAppNews> OnSelectedNewsItemChanged { get; set; }

	[Parameter] public bool IsCurrentlySelected { get; set; }
